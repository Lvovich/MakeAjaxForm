...
window.MakeAjaxForm.prototype.a.select=function(a){for(var b=[],c=[],d=0,f=a.options.length;d<f;d++){var e=a.options[d];!e.disabled&&e.selected&&e.value&&b.push(this.b(a.name,e.value))}a.hasAttribute("required")&&!b.length&&c.push(this.c(a,"required_wo_check"));return{data:b,valid:c}};window.MakeAjaxForm.prototype.a.textarea=function(a){var b=[],c=[];a.value?b.push(this.b(a.name,a.value)):a.hasAttribute("required")&&c.push(this.c(a,"required_wo_value"));return{data:b,valid:c}};window.MakeAjaxForm.prototype.l=function(a){var b=[],c=[];["input","select","textarea"].forEach(function(d){if(d in a.a)for(var f=a.i.querySelectorAll(d),e=0,h=f.length;e<h;e++){var g=f[e];g!==a.h&&g.name&&(g=a.a[d](g),b=b.concat(g.data),c=c.concat(g.valid))}});return{data:b,j:c}};window.MakeAjaxForm.prototype.o=function(a,b){var c=Object.create(null);if(!1===b.onBeforeExchange(a))return!1;if(0<a.j.length)return a.j.forEach(function(a){b.onValidationError(a)}),!1;if(0===a.data.length)return b.onExchangeError("no_valid_data"),!1;c.formData=window.FormData?new FormData:!1;return c};window.MakeAjaxForm.prototype.m=function(a,b,c){var d=Object.create(null);if(b)a.data.forEach(function(a){b.append(a.name,a.g.length?a.g[0]:a.value)}),d.f="",d.data=b;else{var f="maf"+(""+Math.random()).slice(2,18),e="--"+f+"\r\n",h="--"+f+"--\r\n",g=["\r\n"];a.data.forEach(function(a){if(a.g.length)c.onExchangeError("file_exchange_disabled");else g.push('Content-Disposition: form-data; name="'+a.name+'"\r\n\r\n'+a.value+"\r\n")});d.f=f;d.data=g.join(e)+h}return d};
