...
f.target,!0);a.onreadystatechange=function(){if(4===a.readyState)if(clearTimeout(d),200===a.status)f.onExchangeSuccess(a.responseText);else f.onExchangeError(a.status+": "+a.statusText)};c=b.g(c);f.sendAjaxHeader&&a.setRequestHeader("X-Requested-With","XMLHttpRequest");c.c.length&&a.setRequestHeader("Content-Type","multipart/form-data; boundary="+c.c);a.send(c.data)}}}(window.makeAjaxForm)}catch(b){console.dir(b)};
