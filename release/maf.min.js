 ...
 * Author: Lvovich
 *
 * open-source repo: https://github.com/Lvovich/MakeAjaxForm
 *
 * Free code.
 */
(function(){
'use strict';window.MakeAjaxForm=function(a){if("object"!==typeof this||this===window)return console.error('makeAjaxForm: incorrect call without "new". Plugin Off!'),{};(function(){a.container=""+a.container||".eff422e211a0627cfeb1dcc88e75b314146";a.submit=""+a.submit||".eff422e211a0627cfeb1dcc88e75b314146";a.target=""+a.target||"/";"function"!==typeof a.onBeforeExchange&&(a.onBeforeExchange=function(){});"function"!==typeof a.onExchangeSuccess&&(a.onExchangeSuccess=function(){console.warn('makeAjaxForm: parameter "onExchangeSuccess" is not a function')});
"function"!==typeof a.onExchangeError&&(a.onExchangeError=function(){console.warn('makeAjaxForm: parameter "onExchangeError" is not a function')});"function"!==typeof a.onValidationError&&(a.onValidationError=function(){console.warn('makeAjaxForm: parameter "onValidationError" is not a function')})})();return function(c,e){e.i=document.querySelector(a.container);e.h=document.querySelector(a.submit);if(!e.i||!e.h)return console.error('makeAjaxForm: parameters "container" or "submit" is invalid. Plugin Off!'),
{};e.h.addEventListener("click",function(){var b=new XMLHttpRequest,d=c.j(e),g=c.m(d,a);if(!1===g)return!1;var f=setTimeout(function(){b.abort();a.onExchangeError("No server response for a long times. Exchange aborted. Try to reload the page.")},3E4);b.open("post",a.target,!0);b.onreadystatechange=function(){if(4==b.readyState)if(clearTimeout(f),200==b.status)a.onExchangeSuccess(b.responseText);else a.onExchangeError(b.status+": "+b.statusText)};d=c.l(d,g.formData,a);d.f.length&&b.setRequestHeader("Content-Type",
"multipart/form-data; boundary="+d.f);b.send(d.data)})}(window.MakeAjaxForm,this)};(function(a){a.a=Object.create(null);a.a.c=function(c,a){var b=Object.create(null);b.element=c;b.type=a;return b};a.a.b=function(c,a,b){b=b||[];var d=Object.create(null);d.name=c;d.value=a;d.g=b;return d};a.a.input=function(c){var a=[],b=[];c.value?"checkbox"===c.type||"radio"===c.type?c.checked?a.push(this.b(c.name,c.value)):c.hasAttribute("required")&&b.push(this.c(c,"required_wo_check")):"file"===c.type?a.push(this.b(c.name,c.value,c.files)):a.push(this.b(c.name,c.value)):c.hasAttribute("required")&&
